...
export default function Home() {
  return (
    <>
      ...
      <div className="fixed top-4 right-4 md:top-10 md:right-10 z-50 font-mono text-[10px] md:text-sm text-red-carpet mix-blend-screen">
        <div className="flex items-center gap-1.5 md:gap-2">
          <span className="animate-pulse w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-red-carpet inline-block"></span>
          REC [ <span id="frame-display" className="tabular-nums text-white">001</span> / 006 ]
        </div>
      </div>

      {/* Logo (Fixed UI) */}
      <div className="fixed top-4 left-4 md:top-8 md:left-8 z-50 mix-blend-difference cursor-none pointer-events-none">
        <h1 className="font-display font-normal text-base md:text-xl tracking-wide text-white">
          ADVERSE
        </h1>
      </div>

      {/* Timeline Scrubber (Fixed UI) */}
      <div className="fixed bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 w-[80%] max-w-md h-[2px] bg-white/10 z-50 rounded-full overflow-visible hidden md:block">
      ...
      <div className="wrapper relative w-full h-screen overflow-hidden">
        ...
        <div id="film-strip" className="flex h-full w-[600vw] relative will-change-transform">
          ...
          <div className="panel w-screen h-full relative flex-shrink-0 border-r border-white/5 flex items-center bg-[#080808]">
            ...
            <div className="container mx-auto px-4 md:px-32 relative z-10 grid md:grid-cols-12 gap-8 md:gap-12 items-center">
              <div className="md:col-span-8">
                <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-10 opacity-0 reveal-text">
                  <span className="w-8 md:w-12 h-[1px] bg-red-carpet"></span>
                  <span className="font-mono text-red-carpet text-[10px] md:text-xs tracking-widest uppercase">
                    Scene 01: The Hook
                  </span>
                </div>

                <h2 className="text-3xl md:text-7xl font-display leading-[1.1] mb-6 md:mb-8 text-silver-screen opacity-0 reveal-text">
                  Stop making &quot;content&quot;. <br />
                  <span className="italic text-celluloid-cream relative inline-block">
                    Start making cinema.
                    <svg
                      className="absolute -bottom-1 md:-bottom-2 left-0 w-full h-1.5 md:h-2 text-red-carpet"
                      viewBox="0 0 100 10"
                ...
                <p className="font-mono text-xs md:text-xl text-gray-400 max-w-2xl leading-relaxed opacity-0 reveal-text">
            ...
            <div className="absolute inset-0 flex flex-col justify-end pb-16 md:pb-32 px-4 md:px-24">
              <div className="relative z-10 transform md:translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-6 mb-3 md:mb-4">
                  <h2 className="text-4xl md:text-8xl font-display text-white tracking-tight">
                    Vault.io
                  </h2>
                  <span className="inline-block border border-white/30 px-2.5 md:px-3 py-0.5 md:py-1 font-mono text-[9px] md:text-xs text-white/70 rounded-full mb-1 md:mb-6 w-fit">
                    2024 / FINTECH
                  </span>
                </div>

                <div className="mt-3 md:mt-8 max-w-xl">
                  <p className="burned-subtitle font-mono text-xs md:text-lg text-celluloid-cream italic inline-block leading-relaxed px-2 md:px-0">
                ...
                {/* Buttons */}
                <div className="mt-6 md:mt-12 flex gap-3 md:gap-4">
                  <button
                    className="px-6 md:px-8 py-2.5 md:py-3 bg-red-carpet text-white font-oswald font-bold text-xs md:text-sm hover:bg-white hover:text-black transition-colors uppercase tracking-widest interactable touch-manipulation"
          ...
          <div className="panel w-screen h-full relative flex-shrink-0 border-r border-white/5 bg-silver-screen text-film-black flex items-center">
            <div className="container mx-auto px-4 md:px-32 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              <div>
                ...
                <h2 className="text-3xl md:text-7xl font-oswald uppercase mb-6 md:mb-12 tracking-tighter text-black">
                  Production
                  <br />
                  Schedule
                </h2>

                <ul className="space-y-3 md:space-y-6 font-display text-xl md:text-4xl">
                  <li
          ...
          <div className="panel w-screen h-full relative flex-shrink-0 bg-film-black flex flex-col items-center justify-center text-center">
            ...
            <div className="max-w-4xl px-4 md:px-8 relative z-10">
              ...
              <p className="font-mono text-xs md:text-xl text-silver-screen mb-8 md:mb-12 max-w-lg mx-auto">
                Or just the beginning of your brand&apos;s cinematic universe.
              </p>

              <a
                href="#"
                className="inline-block group relative px-8 md:px-16 py-4 md:py-8 bg-transparent overflow-hidden border border-white/20 interactable touch-manipulation"
              ...
              >
                ...
                <span className="relative font-oswald text-base md:text-3xl uppercase tracking-[0.15em] md:tracking-[0.2em] text-white group-hover:text-black z-10 transition-colors duration-300">
                  Start Project
                </span>
              </a>

              <div className="mt-12 md:mt-24 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-[9px] md:text-xs font-mono text-gray-500 uppercase tracking-widest">
